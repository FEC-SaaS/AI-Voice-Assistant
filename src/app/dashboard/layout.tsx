    ...
    <TRPCProvider>
      <BrandingProvider>
        <div className="flex h-screen overflow-hidden bg-background">
          ...
          />
          {/* Previously: sidebarCollapsed ? "lg:ml-0" : "lg:ml-0" — both branches were identical (dead code).
               The sidebar is a flex sibling (not fixed/absolute), so no margin adjustment is needed. */}
