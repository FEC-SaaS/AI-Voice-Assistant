    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {isLoading && (
        <div className="flex items-center justify-center py-20">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-gray-500">Loading active calls...</p>
          </div>
        </div>
      )}
      ...
      {!isLoading && !isError && (
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6" style={{ minHeight: "calc(100vh - 240px)" }}>
          ...
          <div className="w-full lg:w-1/3 rounded-2xl border border-gray-200/50 bg-white shadow-sm overflow-hidden flex flex-col">
            <ActiveCallsList
              calls={calls}
          ...
          <div className="w-full lg:w-2/3 rounded-2xl border border-gray-200/50 bg-white shadow-sm overflow-hidden flex flex-col">
