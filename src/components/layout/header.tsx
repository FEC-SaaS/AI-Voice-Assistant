...
import { Bell, Menu, Bot } from "lucide-react"; // Search removed — search bar not yet implemented
...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-border bg-card/80 backdrop-blur-xl px-4 lg:px-6">
      ...
      {/* Search - non-functional (no onChange/onSubmit wired up), hidden until implemented */}
      ...
      <div className="flex items-center gap-2 lg:gap-4">
        ...
        {/* Notifications — previously showed a hardcoded red dot regardless of actual notifications */}
