    ...
    <div className="flex h-full flex-col">
      ...
      {calls.length === 0 ? (
        <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 text-center">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-secondary to-secondary/50">
            <Phone className="h-7 w-7 text-muted-foreground/70" />
          </div>
